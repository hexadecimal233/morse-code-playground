<template>
  <div class="p-8 max-w-2xl rounded-2xl border-4 border-gray-50">
    ...
    <div class="space-y-6">
      ...
      <div class="space-y-2">
        <label class="font-medium">播放采样</label>
        <select
          v-model="playSample"
          class="w-full p-2 rounded-lg border-2 border-sky-200 focus:outline-none focus:border-sky-300 bg-sky-50">
          <option value="sine">正弦波</option>
          <option value="type">打字音</option>
        </select>
      </div>

      <div class="space-y-2" v-show="playSample === 'sine'">
